"""
Django settings for voe_outage_web project.
...
ROOT_URLCONF = "voe_outage_web.urls"
...
WSGI_APPLICATION = "voe_outage_web.wsgi.application"
...
SYNC_RUN_CRONTAB = os.getenv("SYNC_RUN_CRONTAB", "0 0 */1 * * *")
